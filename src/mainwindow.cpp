...
void KeepassMainWindow::setupIcons(){
	setWindowIcon(customizeIcon(getIcon("hires/keepassx")));
	...
	SysTray->setIcon(customizeIcon(getIcon("hires/keepassx")));
...
void KeepassMainWindow::setLock(){
	...
	setWindowIcon(customizeIcon(getIcon("hires/keepassx-locked")));
	SysTray->setIcon(customizeIcon(getIcon("hires/keepassx-locked")));
